...
export default function RatingContainer({ scoreData }: RatingContainerProps) {
  return (
    <div className="w-full shrink-0 border-b-2 border-t-2 border-gray-200 bg-white px-6 py-8 md:px-[4.5rem]">
      <div className="flex w-full items-center justify-center gap-[10%] md:gap-[15%] lg:gap-[30%]">
