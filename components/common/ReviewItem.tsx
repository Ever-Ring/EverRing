...
export default function ReviewItem({
  ...
  return (
    <div className="flex flex-col items-start gap-6 text-gray-700 sm:flex-row">
      {!isReviewPage && (
      ...
      <div className="flex flex-1 flex-col items-start justify-between gap-2 self-stretch">
